<%-- 
    Document   : index
    Created on : 18-Jun-2023, 12:40:27 am
    Author     : biswa
--%>
    ...
    <body>
        ...
        <div class="container p-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <img alt="" src="img/doct.jpg" style="height:350px; width: 350px;">
                </div>
        ...
        <div class="container p-2">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card paint-card">
                        <div class="card-body text-center">
                            <img src="img/doc_single1.jpg" width="250px" height="300px">
                ...
                <div class="col-md-3">
                    <div class="card paint-card">
                        <div class="card-body text-center">
                            <img src="img/doc_single2.jpg" width="250px" height="300px">
                ...
                <div class="col-md-3">
                    <div class="card paint-card">
                        <div class="card-body text-center">
                            <img src="img/nurse1.jpg" width="250px" height="300px">
